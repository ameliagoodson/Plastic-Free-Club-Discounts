...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  try {
          ...
          fallback: {
            ...
            instructions: [
              ...
              "3. Check if they have the tag: '" +
                (settings?.pfcMemberTag || "plastic-free-club") +
                "'",
              "4. If they have the tag, they should get the discount",
            ],
            configuredTag: settings?.pfcMemberTag || "plastic-free-club",
            discountSettings: {
    ...
    const configuredTag = settings?.pfcMemberTag || "plastic-free-club";
